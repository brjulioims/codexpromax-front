...
var squareExp$2 = 2;
var absorbFactor$1 = .033;
var minOrbitLength = 0;
var minRadius$4 = 0;
var minMass = 0;
var minAngle$2 = 0;
var maxAngle$4 = Math.PI * 2;
var minVelocity$5 = 0;
...
var quarter = .25;
var double$11 = 2;
var doublePI$7 = Math.PI * double$11;
var squareExp$1 = 2;
var half$9 = .5;
...
var minVelocity$4 = 0;
var identity$5 = 1;
var moveSpeedFactor$1 = 60;
var minSpinRadius = 0;
var spinFactor = .01;
var doublePI$5 = Math.PI * double$10;
...
function move(particle, moveOptions, moveSpeed, maxSpeed, moveDrift, reduceFactor, delta) {
	...
	const gravityOptions = particle.gravity, gravityFactor = gravityOptions?.enable && gravityOptions.inverse ? -1 : identity$5;
...
function applyPath(particle, delta) {
	...
	if (pathOptions.clamp) {
		particle.velocity.x = clamp(particle.velocity.x, -1, identity$5);
		particle.velocity.y = clamp(particle.velocity.y, -1, identity$5);
	}
	...
	constructor(container, engine) {
		this._drawLinkLine = (p1, link) => {
			...
			container.canvas.draw((ctx) => {
				...
				if (!colorLine) {
					const linkColor = p1LinksOptions.id !== void 0 ? container.particles.linksColors.get(p1LinksOptions.id) : container.particles.linksColor;
...
var double$3 = 2;
var doublePI$3 = Math.PI * double$3;
var identity$1 = 1;
var doublePIDeg = 360;
...
var TiltUpdater = class {
	...
	init(particle) {
		...
		particle.tilt = {
			...
			sinDirection: getRandom() >= .5 ? identity : -1,
			cosDirection: getRandom() >= .5 ? identity : -1,
			min: 0,
			max: doublePI$2
		};
...
var defaultDistance$1 = 0;
var doublePI$1 = Math.PI * 2;
